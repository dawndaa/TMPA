...
def _build_model_and_optimizer(args, classnames, device):
    ...
    # TMPA adapts only prompt-side parameters and alpha. Freeze the full model
    # before the first forward so the visual backbone/upsampler never build a
    # backward graph (important for high-resolution datasets such as UAVid).
