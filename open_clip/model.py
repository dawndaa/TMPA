...
class CLIP(nn.Module):
    ...
    def encode_image(self,
        ...
        # print('ignore_residual.device', ignore_residual.device)
        # print('output_cls_token.device', output_cls_token.device)
        features = self.visual(image, ignore_residual, output_cls_token)
        if output_cls_token:
